...
mongoose.connect(process.env.MONGO_URL || 'mongodb+srv://meenalgupta2306:meenal@cluster0.hudms.mongodb.net/banking?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true});
